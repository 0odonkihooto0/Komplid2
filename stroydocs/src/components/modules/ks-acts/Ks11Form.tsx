...
import type { KsActFormFields, KsActParticipant, KsActIndicator, KsActWorkItem } from './useKsActForm';
...
export function Ks11Form({ actId, objectId, contractId, formData }: Props) {
