...
interface PirWidgetProps {
  data: WidgetData;
}

export function PirWidget({ data }: PirWidgetProps) {
  const { totalAmount, mastered, completionPercent, planEndDate, delta, isAhead } = data;
    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        ...
        <div className="flex justify-between text-sm">
          <span className="text-muted-foreground">Дата плана</span>
