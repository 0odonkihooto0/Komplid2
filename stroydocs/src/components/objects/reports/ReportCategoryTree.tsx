...
import type { CategoryWithChildren } from './useReportsList';

interface ReportCategoryTreeProps {
...
function CategoryNode({
  ...
  function handleAddChild() {
    ...
    onCreateCategory({ name: childName.trim(), parentId: category.id });
    setChildName('');
  ...
  return (
    <div>
      ...
      <Dialog open={addChildOpen} onOpenChange={setAddChildOpen}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            <DialogTitle>Подкатегория в «{category.name}»</DialogTitle>
          </DialogHeader>
          <Input
