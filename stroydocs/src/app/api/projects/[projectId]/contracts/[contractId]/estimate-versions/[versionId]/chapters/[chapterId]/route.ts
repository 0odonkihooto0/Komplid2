...
type Params = {
  params: { projectId: string; contractId: string; versionId: string; chapterId: string };
};
...
export async function PATCH(
  ...
  try {
    ...
    const chapter = await resolveChapter(
      params.projectId, params.contractId, params.versionId, params.chapterId, session.user.organizationId
    );
