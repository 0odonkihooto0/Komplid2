...
/**
 * GET /api/projects/[projectId]/gantt-versions/compare?v1=uuid1&v2=uuid2
 * Сравнивает задачи двух версий ГПР и возвращает diff.
 * Обе версии должны принадлежать данному объекту строительства.
 */
export async function GET(
  ...
  try {
    ...
    const [v1, v2] = await Promise.all([
      db.ganttVersion.findFirst({ where: { id: v1Id, projectId: params.projectId } }),
      db.ganttVersion.findFirst({ where: { id: v2Id, projectId: params.projectId } }),
    ]);
