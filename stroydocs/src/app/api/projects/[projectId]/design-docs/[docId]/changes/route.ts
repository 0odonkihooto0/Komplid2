...
async function getDocOrThrow(docId: string, projectId: string, organizationId: string) {
...
export async function GET(_req: NextRequest, { params }: Params) {
  try {
    ...
    const doc = await getDocOrThrow(params.docId, params.projectId, session.user.organizationId);
