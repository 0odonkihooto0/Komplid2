...
async function verifyObjectAccess(objectId: string, organizationId: string) {
...
export async function GET(
  ...
  try {
    ...
    const object = await verifyObjectAccess(params.objectId, session.user.organizationId);
