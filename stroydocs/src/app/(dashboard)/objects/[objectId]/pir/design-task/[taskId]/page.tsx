...
export default function PIRDesignTaskDetailPage({
  params,
}: {
    ...
    return (
      <div className="py-12 text-center">
        ...
        <Button
          variant="link"
          className="mt-2"
          onClick={() => router.push(`/objects/${params.objectId}/pir/design-task`)}
        >
          Вернуться к списку
        </Button>
      </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h1 className="text-lg font-semibold">Задание на ПИР №{task.number}</h1>
